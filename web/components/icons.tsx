...
export const BlendIcon = (props: IconProps) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="m11.14 7.86-2.07 2.07a2 2 0 0 0 0 2.83l5.8 5.8a2 2 0 0 0 2.83 0l2.07-2.07" />
        <path d="m15.29 16.41 1.82-1.82a2 2 0 0 0 0-2.83L10.29 5a2 2 0 0 0-2.83 0L5.64 6.81" />
        <path d="M16 22h2" />
        <path d="M12 22h2" />
        <path d="M20 16v2" />
        <path d="M20 12v2" />
