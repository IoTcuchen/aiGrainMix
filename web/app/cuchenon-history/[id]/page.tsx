...
import { Activity, Router, ChefHat, Database, Smartphone, Cpu, Users, HelpCircle, ArrowUpRight, Server, TrendingUp, BarChart2, BarChart3, Calendar, Clock, Hash, Heart, Zap, Download } from 'lucide-react';
    ...
    const handleSavePage = async () => {
        ...
        try {
            ...
            for (const key of tabKeys) {
                ...
                setActiveTab(key);
                // recharts ResponsiveContainer가 사이즈 측정 + 차트 렌더링까지 대기
