...
// 자바 서버 주소 (LOCAL_API_URL in .env)
const BASE_URL = process.env.LOCAL_API_URL || "http://localhost:8080";
...
export async function POST(request: Request) {
    try {
        ...
        const aiResult: any = await request.json();
